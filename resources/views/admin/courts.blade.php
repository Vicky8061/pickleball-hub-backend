    ...
    <div class="card border-0 shadow-sm rounded-4 p-3.5 mb-4 bg-white">
        <div class="row g-3 align-items-center">
            ...
            <div class="col-lg-6 col-12">
                <div class="nav nav-pills gap-1 p-1 bg-light rounded-pill d-inline-flex border" id="courtStatusPillsNav">
                    <button class="nav-link active rounded-pill px-3 py-1.5 fs-8 fw-bold" data-status="">All Courts</button>
                    <button class="nav-link rounded-pill px-3 py-1.5 fs-8 fw-bold text-success" data-status="active">Active</button>
                    <button class="nav-link rounded-pill px-3 py-1.5 fs-8 fw-bold text-danger" data-status="inactive">Inactive / Suspended</button>
                </div>
            </div>
